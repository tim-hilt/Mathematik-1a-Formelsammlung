...
\begin{itemize}
\item \makebox[4cm]{Periodendauer \(T\): \hfill} \(T = \frac{2\pi}{\omega}\)
\item \makebox[4cm]{Nullstellen: \hfill} \(t = - \frac{\varphi}{\omega} + \frac{T}{4} + \frac{kT}{2} \qquad ;k \in \mathbb{Z}\)
\item \makebox[4cm]{Hochpunktstellen: \hfill} \(t = - \frac{\varphi}{\omega} + kT \qquad ;k \in \mathbb{Z}\)
\item \makebox[4cm]{Tiefpunktstellen: \hfill} \(t = - \frac{\varphi}{\omega} + \frac{T}{2} + kT \qquad ;k \in \mathbb{Z}\)
\end{itemize}
...
\begin{itemize}
\item \makebox[4cm]{Achsensymmetrie: \hfill} \(f(x) = f(-x)\)
\item \makebox[4cm]{Punktsymmetrie: \hfill} \(f(-x) = -f(x)\)
\end{itemize}
...
\textbf{Um zu prüfen ob Hoch- oder Tiefpunkt vorliegt wird in die Ableitungsfunktion ein Punkt vor- und ein Punkt nach der berechneten Extremstelle \(x_0\) eingegeben! Wechselt hier das Vorzeichen von \dots
  \begin{itemize}
  \item \makebox[5cm]{- nach +: \hfill} Steigung ist zuerst negativ, dann positiv $\rightarrow$ Tiefpunkt
  \item \makebox[5cm]{+ nach -: \hfill} Steigung ist zuerst positiv, dann negativ $\rightarrow$ Hochpunkt
  \item \makebox[5cm]{- nach - oder + nach +: \hfill} Steigung wechselt das Vorzeichen nicht $\rightarrow$ Sattelpunkt
  \end{itemize}
}
